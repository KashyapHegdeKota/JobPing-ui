...
export interface FilterBarProps { query: string; category: Category; remoteOnly: boolean; onQueryChange: (event: ChangeEvent<HTMLInputElement>) => void; onCategoryChange: (category: Category) => void; onRemoteChange: (value: boolean) => void; }

export default function FilterBar({ query, category, remoteOnly, onQueryChange, onCategoryChange, onRemoteChange }: FilterBarProps) {
